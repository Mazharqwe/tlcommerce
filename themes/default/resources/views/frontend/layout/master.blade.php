...
<body class="@if ($mood == 'dark') dark @endif @if ($rtl) rtl-mode @endif @if($currentRoute == 'theme.default.home') home-page @endif">
    <!-- Preloader -->
    ...
    <script>
        ...
        (function($) {
            ...
            $(document).ready(function() {
                ...
                let footerSubmitCheckbox = $('.footerNewsletter .newsletterForm .footer-checkbox-cover input[type="checkbox"]');
