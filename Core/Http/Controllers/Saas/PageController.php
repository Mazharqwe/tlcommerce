...
use Core\Repositories\saas\PageRepository;
...
class PageController extends Controller
{
  ...
  public function page(Request $request)
  {
    try {
      ...
      return view('core::base.saas.pages.pages', compact('pages'));
    } catch (\Exception $e) {
  ...
  public function addPage()
  {
    try {
      ...
      return view('core::base.saas.pages.add_page', compact('pages', 'page_templates'));
    } catch (\Exception $e) {
  ...
  public function editPage(Request $request)
  {
    try {
      if ($request->permalink && $request->lang) {
        ...
        $page_templates = $this->page_repository->getPageTemplates()->get();
        return view('core::base.saas.pages.edit_page', compact('page', 'parent_pages', 'page_templates', 'languages', 'lang'));
      } else {
        toastNotification('error', translate('Page not found'));
