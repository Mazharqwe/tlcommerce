...
class TagController extends Controller
{
    ...
    public function tag(Request $request)
    {
        try {
            ...
            return view('core::base.saas.blog.tag.tag', compact('tags'));
        } catch (\Exception $e) {
    ...
    {
        return view('core::base.saas.blog.tag.add_tag');
    }
    ...
    public function editTag(Request $request, $id)
    {
        try {
            if ($request->id && is_numeric($request->id) && $request->lang) {
                ...
                return view('core::base.saas.blog.tag.edit_tag', compact('tag', 'languages', 'lang'));
            } else {
