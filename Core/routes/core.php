...
use Core\Http\Controllers\Saas\TagController;
use Core\Http\Controllers\DashboardController;
use Core\Http\Controllers\Saas\BlogController;
use Core\Http\Controllers\Saas\PageController;
...
use Core\Http\Controllers\Saas\CommentController;
use Core\Http\Controllers\RolePermissionController;
use Core\Http\Controllers\GeneralSettingsController;
use Core\Http\Controllers\Saas\BlogCategoryController;
...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::group(['prefix' => 'site-map'], function () {
        if (isTenant()) {
            ...
            Route::get('', [SiteMapController::class, 'sitemap'])->name('core.admin.site.map');
            Route::post('generate', [SiteMapController::class, 'generateSaasSitemap'])->name('core.admin.site.map.generate')->middleware('demo');
            Route::get('download', [SiteMapController::class, 'downloadSaasSitemap'])->name('core.admin.site.map.download');
        }
    });
