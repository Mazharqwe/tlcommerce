...
class SupportTicketController extends Controller
{
    ...
    public function allCategories()
    {
        ...
        return view('plugin/support-ticket::support-tickets.categories', compact('categories'));
    }
    ...
    public function createCategory(Request $request)
    {
        ...
        try {
            ...
            toastNotification('erroe', translate("Unable to create ticket category"));
            return redirect()->back();
        }
    }
    ...
    {
        return view('plugin/support-ticket::support-tickets.create_ticket');
    }
    ...
    public function storeSupportTicket(Request $request)
    {
        ...
        try {
            ...
            if (!empty($request['ticket_file'])) {
                $ticket->attachment = $request['ticket_file'];
            }
            $ticket->saveOrFail();
    ...
    public function supportTickets()
    {
        ...
        return view('plugin/support-ticket::support-tickets.all_tickets', compact('tickets'));
    }
    ...
    public function editSupportTickets($id)
    {
        ...
        return view('plugin/support-ticket::support-tickets.edit_ticket', compact('ticket'));
    }
    ...
    public function supportTicketDetails($id)
    {
        ...
        $ticket_replies = TicketReplies::with('repliedBy')->where('ticket_id', $id)->get();

        $all_other_tickets = Ticket::where('created_by', $ticket->created_by)->with('categoryDetails', 'assignedTo', 'createdBy', 'replays')->get();

        return view('plugin/support-ticket::support-tickets.ticket_details', compact('ticket', 'ticket_replies', 'all_other_tickets'));
    }
    ...
    public function replySupportTicket(Request $request)
    {
        ...
        try {
            ...
            if (!empty($request['ticket_file'])) {
                $ticket_replay->attachment = $request['ticket_file'];
            }
