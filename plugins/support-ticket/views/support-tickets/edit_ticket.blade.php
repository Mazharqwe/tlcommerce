...
@section('main_content')
    <!-- Main Content -->
    <form class="form-horizontal my-4 mb-4" id="update_ticket" action="{{ route('update.support.ticket') }}"
                                ...
                                <select class="theme-input-style" name="category" id="category">
                                    ...
                                    @foreach ($categories as $category)
                                        <option value="{{ $category->id }}"
                                            {{ $category->id == $ticket->category ? 'selected' : '' }}>{{ $category->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group my-4 col-md-6">
                                ...
                                <select class="theme-input-style" name="user" id="user">
                                    ...
                                    @foreach ($staffs as $staff)
                                        <option value="{{ $staff->id }}" {{ ($staff->id == $ticket->assigned_to) ? 'selected' : '' }}>{{ $staff->name }}</option>
                                    @endforeach
                                </select>
                                @if ($errors->has('user'))
