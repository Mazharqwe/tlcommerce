...
class CouponController extends Controller
{
    ...
    public function __construct(CouponPackageRepository $coupon_package_repo)
    {
    ...
    {
        return view('plugin/saas::coupons.create_coupon');
    }
    ...
    {
        $coupons = DB::table('tl_saas_coupons')
            ->orderBy('id', 'desc')
            ->select(['*'])
            ->get();

        return view('plugin/saas::coupons.index', compact('coupons'));
    }
    ...
    public function editCoupon($id)
    {
        ...
        return view('plugin/saas::coupons.edit_coupon', compact('coupon'));
    }
     ...
     */
    public function getPackagesAccordingToRedeemableCoupon(Request $request)
    {
        try {
            ...
            $package = $this->coupon_package_repo->packagesOfCouponType($match_case, $data)->first();
