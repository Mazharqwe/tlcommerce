...
class SystemController extends Controller
{
    ...
    public function generalSettings()
    {
        ...
        return view('plugin/saas::settings.general_settings', compact('settings_data'));
    }
     ...
     */
    public function saasNotificationSettings()
    {
        ...
        return view('plugin/saas::settings.notification_settings',compact('settings_data'));
    }
