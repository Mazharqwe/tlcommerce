...
class CurrencyController extends Controller
{
    ...
    {
        return view('plugin/saas::currency.add_currency');
    }
    ...
    public function allCurrencies()
    {
        ...
        return view('plugin/saas::currency.index', compact('all_currencies'));
    }
    ...
    public function editCurrency($id)
    {
        try {
            ...
            return view('plugin/saas::currency.edit_currency', compact('currency'));
        } catch (\Exception $th) {
