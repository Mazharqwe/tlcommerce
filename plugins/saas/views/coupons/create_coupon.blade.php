                ...
                <div class="card mb-30">
                    <div class="card-body row">
                        <div class="d-sm-flex justify-content-between align-items-center m-3">
                            <h4 class="font-20">{{ translate('Create Coupons') }}</h4>
                        </div>
                        ...
                        <div class="my-3 col-md-12">
                            <label class="font-14 bold black mb-2">{{ translate('Number Of Times This Coupon Can Be Used') }} <span class="required">
                                    *</span></label>
                            <input type="number" min="1" class="theme-input-style" name="coupon_usable_times" id="coupon_usable_times" value="1">
