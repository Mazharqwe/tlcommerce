 @php
     ...
     $selecected_currency = \Plugin\Saas\Repositories\PaymentMethodRepository::configKeyValue($method->id, 'mollie_currency');
 ...
 <div class="border-top2 p-3 payment-method-item-body">
     <div class="configuration">
         <form id="credential-form-{{ $method->id }}">
             ...
             <div class="form-group mb-20">
                ...
                <div class="mb-2">
                    <a href="/admin/ecommerce-settings/add-currency" class="mt-2">({{ translate('Please setup exchange rate for the choosed currency') }})</a>
                </div>
                 <div class="input-option">
     ...
     <div class="instruction">
         ...
         <ol>
             ...
             <li style="list-style-type: decimal">
                 <p>
                     {{translate('See mollie supported currency list,')}} <a href="https://docs.mollie.com/payments/multicurrency">here</a>
                 </p>
             </li>
         </ol>
     </div>
