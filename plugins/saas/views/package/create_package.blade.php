                ...
                <div class="card mb-30">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="form-group my-4 col-md-4 mb-2">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group my-4 col-md-4 mb-2"  id="trail_period_div">
                                <label class="font-14 bold black">{{ translate('Trial Period') }} <span
                                        class="text-danger"> *
                                    </span></label>
                                <input type="number" name="trail_period" id="trail_period" class="theme-input-style"
                                    ...
                                    @if ($plugin->type != 'saas' && $plugin->location != 'tlecommercecore')
                                        <div class="form-group d-flex justify-content-between">
                                            ...
                                            <label class="switch glow primary medium">
                                                <input type="checkbox" name="package_plugins_{{ $plugin->id }}"
                                                    value="{{ $plugin->id }}">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="package_privileges_create_page" class="theme-input-style"
                                        placeholder="{{ translate('Number of pages can create') }}" min="-1" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="package_privileges_create_blog" class="theme-input-style"
                                        placeholder="{{ translate('Number of blogs can create') }}" min="-1" required>
                                    <label class="font-12 bold">{{ translate('-1 For Unlimitted') }}</label>
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="number" name="package_privileges_create_product"
                                        ...
                                        placeholder="{{ translate('Number of products can upload') }}" min="-1" required>
                                    <label class="font-12 bold">{{ translate('-1 For Unlimitted') }}</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="package_privileges_customers" class="theme-input-style"
                                        placeholder="{{ translate('Number of customers can have') }}" min="-1" required>
                                    <label class="font-12 bold">{{ translate('-1 For Unlimitted') }}</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="package_privileges_custom_domain"
                                        class="theme-input-style"
                                        placeholder="{{ translate('Number of custom domains') }}" min="-1" required>
                                    <label class="font-12 bold">{{ translate('-1 For Unlimitted') }}</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="package_privileges_allocated_storage"
                                        class="theme-input-style"
                                        placeholder="{{ translate('Maximum Allocated Storage') }}" min="-1" required>
                                    <label class="font-12 bold">{{ translate('-1 For Unlimitted') }}</label>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                @foreach ($payment_methods as $method => $id)
                                    <div class="form-group d-flex justify-content-between">
                                        ...
                                        <label class="switch glow primary medium">
                                            <input type="checkbox" name="package_payment_method_{{ $id }}"
                                                value="{{ $id }}">
                                            <span class="control"></span>
                                        </label>
                                    </div>
