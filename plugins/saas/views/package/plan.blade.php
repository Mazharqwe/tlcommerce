                    ...
                    <form method="post" action="#" id="createPlanForm">
                        <div class="modal-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="plan-name" name="plan_name">
                                <p class="text-danger" id="plan_name"></p>
                            </div>
                            <div class="form-group">
                                <label for="plan-duration"
                                    class="col-form-label">{{ translate('Plan Durationn (Days)') }}</label>
                                <input type="number" class="form-control" id="plan-duration" name="plan_duration">
                                <p class="text-danger" id="plan_duration"></p>
                            </div>
                    ...
                    <form method="post" action="#" id="editPlanForm">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                ...
                                <p class="text-danger" id="plan_name_update"></p>
                            </div>
                            <div class="form-group">
                                <label for="plan-duration"
                                    class="col-form-label">{{ translate('Plan Durationn (Days)') }}</label>
                                <input type="number" class="form-control" id="editable-plan-duration"
                                    name="plan_duration">
                                <p class="text-danger" id="plan_duration_update"></p>
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn long btn-danger"
                                ...
                                if (errors.hasOwnProperty(field)) {
                                    ...
                                    for (var i = 0; i < fieldErrors.length; i++) {
                                        if(field == 'plan_duration'){
                                            $('#plan_duration').html(fieldErrors[i])
                                        }
                                        if(field == 'plan_name'){
                                            $('#plan_name').html(fieldErrors[i])
                                        }
                                    }
                                }
                            }
                        ...
                        if (response.success) {
                            ...
                            for (var field in errors) {
                                if (errors.hasOwnProperty(field)) {
                                    ...
                                    for (var i = 0; i < fieldErrors.length; i++) {
                                        if(field == 'plan_duration'){
                                            $('#plan_duration_update').html(fieldErrors[i])
                                        }
                                        if(field == 'plan_name'){
                                            $('#plan_name_update').html(fieldErrors[i])
                                        }
                                    }
                                }
                            }
