            ...
            <div class="card mb-30">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <button class="btn btn-info sm" data-toggle="modal" data-target="#customDomainModal">
                                            ...
                                            <table class="border">
                                                <tbody>
                                                    @for ($i = 0; $i < sizeof($requested_domain); $i++)
                                                        <tr class="border-left2 border-right2 border border-bottom2">
                                                            <td>{{ $requested_domain[$i] }}</td>
                                                            @if ($status[$i] == 0)
                                                                <td>
                                                                    <span
                                                                        class="badge badge-warning mb-2">{{ translate('Pending') }}</span>
                                                                </td>
                                                            @endif
                                                            @if ($status[$i] == 1)
                                                                <td> <span
                                                                        class="badge badge-success mb-2">{{ translate('Approved') }}</span>
                                                                </td>
                                                            @endif
                                                            @if ($status[$i] == 2)
                                                                <td> <span
                                                                        class="badge badge-danger mb-2">{{ translate('Cancelled') }}</span>
                                                                </td>
                                                            @endif
                                                            ...
                                                            @endif
                                                            @if ($status[$i] == 1)
                                                                <td> {{ $approved_date[$i] }} - {{ translate('Present') }}
                                                                </td>
                                                            @endif
                                                            @if ($status[$i] == 2)
                                                                <td> {{ $approved_date[$i] }} - {{ $cancelled_date[$i] }}
                                                                </td>
                                                            @endif
                                                        </tr>
                                                    @endfor
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">{{ translate('Request Domain') }}</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group mb-20">
                        <label for="current_domain"
                            class="mb-2 font-14 bold black">{{ translate('Select Current Domain') }}<span
                                class="text-danger"> *
                            </span></label>
                        <select class="theme-input-style" id="current_domain" name="current_domain">
                            <option>{{ translate('Select Domain') }}</option>
