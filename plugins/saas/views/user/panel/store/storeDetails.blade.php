...
@section('main_content')
                    ...
                    <div class="col-md-8">
                        <div class="invoice-left">
                            <h3 class="mb-3 text-white">
                                ...
                                <button class="sm btn-success status-btn" data-toggle="modal"
                                    data-target="#updateStoreModal"><i class="icofont-edit-alt"></i></button>
                            </h3>
    ...
    <div class="modal fade" id="updateStoreModal" tabindex="-1" role="dialog" aria-labelledby="updateStoreModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">{{ translate('Update Stroe Name') }}</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form action="{{ route('plugin.saas.update.store') }}" method="post">
                    @csrf
                    <div class="modal-body">
                        <input type="hidden" id="store_id" name="store_id" value="{{ $saas_account_details->store_id }}">
                        <div class="form-group mb-20">
                            <input type="text" id="store_name" name="store_name" class="theme-input-style"
                                placeholder="{{ translate('Store Name') }}"
                                value="{{ $saas_account_details->store_name }}">
