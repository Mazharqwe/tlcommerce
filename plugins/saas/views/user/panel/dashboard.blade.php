...
<div class="row">
    ...
    <div class="col-md-12">
        <div class="card mb-30">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    @if($is_extended)
                    <a href="{{ route('plugin.saas.subscribe.now') }}" class="btn btn-info sm">{{ translate('Create Store') }}</a>
                    @endif
                </div>
            </div>
                            ...
                            <td class="text-center">
                                <div class="dropdown-button">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <a href="{{ route('plugin.saas.user.store.details', $store->id) }}">{{ translate('Show Details') }}</a>
                                        @if ($store->status == 1)
                                        ...
                                        @endif
                                        @if($is_extended)
                                        <a href="{{ route('plugin.saas.change.subscription.plan', $store->id) }}">{{ translate('Upgrade Plan') }}</a>
                                        @endif
                                        @endif
                                    </div>
                                </div>
        ...
        <div class="card mb-30">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <h4 class="font-20">{{ translate('Latest Payment') }}</h4>
                </div>
            </div>
            <div class="table-responsive">
                <table class="hoverable text-nowrap border-top2 " id="payment_history">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('plugin.saas.print.subscription.payment.invoice', $payment->store_id) }}" class="btn btn-success sm">{{ translate('Invoice') }}</a>
                            </td>
                        </tr>
                        @php
                        $key++;
        ...
        <div class="card mb-30">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <h4 class="font-20">{{ translate('Latest Domain Requests') }}</h4>
                </div>
            </div>
            <div class="table-responsive">
                <table class="hoverable text-nowrap border-top2" id="domain_request_history">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $domain->current_domain }} <span class="badge mb-2 {{ $class }}">{{ $status }}</span></td>
