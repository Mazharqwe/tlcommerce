...
$reg_bg_image = !empty($auth_layout['user_reg_bg_image']) ? asset(getFilePath($auth_layout['user_reg_bg_image'])) : '';
@endphp
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-12 col-md-6">
                                            <div class="form-group mb-20">
                                                <label for="name" class="mb-2 font-14 bold black">{{ translate('Name') }} <span class="text-danger"> *
                                                    </span></label>
                                                <input type="text" id="name" name="name" class="theme-input-style" placeholder="{{ translate('Name') }}" value="{{ old('name') }}">
                                                @if ($errors->has('name'))
                                        ...
                                        <div class="col-12 col-md-6">
                                            <div class="form-group mb-20">
                                                <label for="email" class="mb-2 font-14 bold black">{{ translate('Email') }} <span class="text-danger"> *
                                                    </span></label>
                                                <input type="email" id="email" name="email" class="theme-input-style" placeholder="{{ translate('Email Address') }}">
                                                @if ($errors->has('email'))
                                        ...
                                        <div class="col-12 col-md-6">
                                            <div class="form-group mb-20">
                                                <label for="password" class="mb-2 font-14 bold black">{{ translate('Password') }}
                                        ...
                                        <div class="col-12 col-md-6">
                                            <div class="form-group mb-20">
                                                <label for="password_confirmation" class="mb-2 font-14 bold black">{{ translate('Password Confirmation') }}
                                                    <span class="text-danger"> *</span></label>
                                                <input type="password" id="password_confirmation" name="password_confirmation" class="theme-input-style" placeholder="{{ translate('******') }}">
                                        ...
                                        <div class="col-12 col-md-6">
                                            <div class="form-group mb-20">
                                                <label for="store_name" class="mb-2 font-14 bold black">{{ translate('Store Name') }} <span class="text-danger"> *
                                                    </span></label>
                                                <input type="text" id="store_name" name="store_name" class="theme-input-style" placeholder="{{ translate('Store Name') }}">
                                        ...
                                        <div class="col-12 col-md-6">
                                            <div class="form-group mb-20">
                                                <label for="coupon" class="mb-2 font-14 bold black">{{ translate('Coupon') }}</label>
                                                <div class="d-flex">
                                                    <input type="text" id="coupon" name="coupon" class="theme-input-style" placeholder="{{ translate('Coupon') }}">
                                                    <input type="hidden" name="is_redeem_coupon" value="0" id="is_redeem_coupon">
                                                    <button type="button" class="btn btn-square sm ml-2" onclick="getPackagesAccordingToCoupon()">{{ translate('Apply') }}</button>
                                                </div>
                                    ...
                                    <div class="d-flex align-items-center mb-20 mt-2">
                                        <button type="submit" class="btn long w-100" class="submit-btn" id="register">
                                    ...
                                    <div class="d-flex justify-content-center">
                                        <p>{{ translate('Already have account? ') }}
                                            <a href="{{ route('subscriber.login') }}" class="font-14">{{ translate('Sign In') }}</a>
                                        </p>
                                    </div>
                                </div>
                            </div>
