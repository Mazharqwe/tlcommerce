        ...
        <div class="card mb-30 h-100">
            <div class="card-body">
                <div class="d-flex align-items-start align-items-sm-end justify-content-between mb-3">
                    <div class="">
                        <h4 class="mb-1">{{ translate('New Customers') }}</h4>
                    </div>
                </div>
                <div class="customer-list">
                    ...
                    <div class="product-list-item mb-20 d-flex justify-content-between align-items-center">
                        <div class="d-flex align-items-center">
                            <div class="img mr-3">
                                <img src="{{ asset(getFilePath($customer->image, true)) }}" alt="{{ $customer->name }}">
                            </div>
                            <div class="content">
                                <a href="{{ route('plugin.saas.customer.details', ['id' => $customer->id]) }}" class="black mb-1">{{ $customer->name }}
                                </a>
                            </div>
                        </div>
                    </div>
