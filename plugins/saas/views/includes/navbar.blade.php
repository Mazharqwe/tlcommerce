...
@if ($user_type != config('saas.user_type.subscriber'))
    ...
    @if (auth()->user()->can('Manage Coupons'))
        <li
            class="{{ Request::routeIs(['plugin.saas.create.coupons', 'plugin.saas.coupons']) ? 'active sub-menu-opened' : '' }}">
            <a href="#">
            ...
            <ul class="nav sub-menu">
                <li class="{{ Request::routeIs('plugin.saas.create.coupons') ? 'active ' : '' }}">
                    <a href="{{ route('plugin.saas.create.coupons') }}">{{ translate('Add Coupons') }}</a>
                </li>
    ...
    @if (auth()->user()->can('Manage SAAS Settings'))
        <li
            class="{{ Request::routeIs(['plugin.saas.all.currencies', 'plugin.saas.general.settings', 'plugin.saas.notification.settings']) ? 'active sub-menu-opened' : '' }}">
            <a href="#">
                <i class="icofont-settings-alt"></i>
                <span class="link-title">{{ translate('SAAS Settings') }}</span>
            </a>
            <ul class="nav sub-menu">
                <li class="{{ Request::routeIs(['plugin.saas.all.currencies']) ? 'active ' : '' }}">
    ...
    @if (auth()->user()->can('Manage Subscriptions'))
        <li
            class="{{ Request::routeIs(['plugin.saas.all.stores', 'plugin.saas.admin.payment.history', 'plugin.saas.all.customers', 'plugin.saas.admin.custom.domain.request']) ? 'active sub-menu-opened' : '' }}">
            <a href="#">
                <i class="icofont-cube"></i>
                <span class="link-title">{{ translate('Subscriptions') }}</span>
            </a>
            <ul class="nav sub-menu">
                <li class="{{ Request::routeIs(['plugin.saas.all.customers']) ? 'active ' : '' }}">
                    <a href="{{ route('plugin.saas.all.customers') }}">{{ translate('Customers') }}</a>
                </li>
                ...
                <li class="{{ Request::routeIs(['plugin.saas.admin.custom.domain.request']) ? 'active ' : '' }}">
                    <a
                        href="{{ route('plugin.saas.admin.custom.domain.request') }}">{{ translate('Custom Domain Request') }}</a>
                </li>
            </ul>
        </li>
    @endif
