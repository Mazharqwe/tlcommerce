                        ...
                        <form action="{{ route('plugin.saas.admin.notification.settings') }}" method="POST"
                            ...
                            <div class="form-row mb-20">
                                <div class="col-md-12">
                                    ...
                                    <select id='roles_of_new_custom_domain_req_noti' name="roles_of_new_custom_domain_req_noti[]"
                                        class="theme-input-style" multiple>
                                        @foreach ($roles as $role)
                                            <option value="{{ $role->id }}" class="text-uppercase"
                                    ...
                                    @if ($errors->has('roles_of_new_custom_domain_req_noti'))
                                        <div class="invalid-input">{{ $errors->first('roles_of_new_custom_domain_req_noti') }}</div>
                                    @endif
                                </div>
                            </div>
